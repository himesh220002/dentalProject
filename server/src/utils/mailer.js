    ...
    const htmlContent = `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; border: 1px solid #e2e8f0; border-radius: 12px; overflow: hidden;">
            <div style="background-color: #2563eb; color: white; padding: 24px; text-align: center;">
                <h1 style="margin: 0; font-size: 24px;">ToothOp</h1>
            </div>
            <div style="padding: 24px; color: #1e293b;">
                ...
                <div style="margin-top: 24px; font-size: 14px; color: #64748b;">
                    <p>Thank you for choosing ToothOp.</p>
                </div>
            </div>
            <div style="background-color: #f1f5f9; padding: 16px; text-align: center; font-size: 12px; color: #94a3b8;">
                &copy; 2026 ToothOp. All rights reserved.
            </div>
        </div>
    `;

    const data = {
        from: `ToothOp <mailgun@${DOMAIN}>`,
        to: [patientEmail],
        subject: isReschedule ? 'Appointment Rescheduled - ToothOp' : 'Appointment Fixed - ToothOp',
        html: htmlContent
    };
