...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-[80vh] flex items-center justify-center px-4 bg-[#fcfcfc]">
            <div className="max-w-sm w-full bg-white rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-8 sm:p-10 border border-gray-100">
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-2xl font-serif font-medium text-gray-900 mb-2">Welcome Back</h1>
                    <p className="text-sm text-gray-500 font-medium font-sans">Sign in to access your records</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-5 font-sans">
                    ...
                    <button
                        type="submit"
                        disabled={isLoading}
                        className="w-full flex items-center justify-center bg-gray-900 text-white py-3.5 rounded-xl text-sm font-bold shadow-lg shadow-gray-900/20 hover:bg-gray-800 transition-all active:scale-[0.98] disabled:opacity-70 disabled:cursor-not-allowed mt-2"
                    >
                        {isLoading ? (
                ...
                <div className="mt-8 text-center text-sm font-medium text-gray-500">
                    ...
                    <Link href="/register" className="text-gray-900 hover:underline font-bold">
                        Create one
                    </Link>
                </div>
            </div>
