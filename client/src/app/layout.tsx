...
export async function generateMetadata() {
    try {
        ...
        const baseUrl = process.env.NEXT_PUBLIC_FRONTEND_URL || 'https://toothopdental.in';
        const clinicName = clinic.clinicName || 'ToothOp';
...
export default async function RootLayout({
    ...
    return (
        <html lang="en">
            <body className="flex flex-col min-h-screen bg-gradient-to-br from-[#060a1e] to-[#0f2850] text-gray-900 font-sans antialiased">
                <script
